  ...
  <div class="box">
    ...
    <div class="classflies">
      ...
      <div class="classfiles_top">
        <!-- <van-skeleton title avatar :row="1" :loading="loading" row-width="70%"> -->
  ...
  .chooseflower {
    ...
    .chooseflower_center {
      ...
      .choose_box {
        ...
        &:nth-of-type(2) .choose_box_bottom {
          background-color: green;
        }
        &:nth-of-type(3) .choose_box_bottom {
